...
#include "New/Managers/Layer/LayerManager.h"
#include "New/Rendering/3D/Layer/Layer3D.h"
	...
	bool AtlasEngine::Start() {
        ...
        while (!glfwWindowShouldClose(Global::Variables.window))
        {
            ...
            {
                {
                    ...
                    ImGui::Checkbox("Enable movement", &Global::Variables.keyIn.shouldRecieveInput);
                    ImGui::Checkbox("Enable look", &Global::Variables.mouseIn.shouldRecieveInput);
                    ImGui::End();
                }
                {
                    // POSITION CHANGER
            ...
            if (Global::Variables.keyIn.kPressed) {
                ...
                Global::Variables.keyIn.shouldRecieveInput = false;
                Global::Variables.mouseIn.shouldRecieveInput = false;
            }
