...
#include "Shared/S_Vendor/S_Bullet/Bullet3Common/b3AlignedObjectArray.h"
...
#include "Shared/S_Vendor/S_Bullet/Bullet3Common/Shared/b3Int4.h"
#include "Shared/S_Vendor/S_Bullet/Bullet3Collision/NarrowPhaseCollision/Shared/b3RigidBodyData.h"
#include "Shared/S_Vendor/S_Bullet/Bullet3Collision/NarrowPhaseCollision/Shared/b3Contact4Data.h"
...
protected:
	...
	int registerConcaveL_MeshShape(b3AlignedObjectArray<b3Vector3>* vertices, b3AlignedObjectArray<int>* indices, b3Collidable& col, const float* scaling);
...
public:
	...
	int registerConcaveL_Mesh(b3AlignedObjectArray<b3Vector3>* vertices, b3AlignedObjectArray<int>* indices, const float* scaling);
