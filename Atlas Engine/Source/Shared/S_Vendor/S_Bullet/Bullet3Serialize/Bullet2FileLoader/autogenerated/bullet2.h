...
class b3L_MeshPartData;
class b3StridingL_MeshInterfaceData;
class b3TriangleL_MeshShapeData;
class b3ScaledTriangleL_MeshShapeData;
...
class b3GImpactL_MeshShapeData;
...
{
public:
	b3L_MeshPartData *m_meshPartsPtr;
	b3Vector3FloatData m_scaling;
	int m_numL_MeshParts;
	char m_padding[4];
};
...
public:
	b3CollisionShapeData m_collisionShapeData;
	b3StridingL_MeshInterfaceData m_meshInterface;
...
{
public:
	b3TriangleL_MeshShapeData m_trimeshShapeData;
	b3Vector3FloatData m_localScaling;
};
