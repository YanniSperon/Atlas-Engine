...
#include "Shared/S_Vendor/S_Bullet/BulletCollision/CollisionShapes/btSdfCollisionShape.h"
...
btScalar btConvexConcaveCollisionAlgorithm::calculateTimeOfImpact(btCollisionObject* body0, btCollisionObject* body1, const btDispatcherInfo& dispatchInfo, btManifoldResult* resultOut)
{
	...
	if (triBody->getCollisionShape()->isConcave())
	{
		...
		btConcaveShape* triangleL_Mesh = (btConcaveShape*)concavebody->getCollisionShape();

		if (triangleL_Mesh)
		{
			triangleL_Mesh->processAllTriangles(&raycastCallback, rayAabbMin, rayAabbMax);
		}
