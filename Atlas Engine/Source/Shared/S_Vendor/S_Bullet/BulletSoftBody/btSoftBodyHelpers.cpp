...
#include "Shared/S_Vendor/S_Bullet/LinearMath/btConvexHull.h"
...
//
btSoftBody* btSoftBodyHelpers::CreateFromTriL_Mesh(btSoftBodyWorldInfo& worldInfo, const btScalar* vertices,
												 const int* triangles,
